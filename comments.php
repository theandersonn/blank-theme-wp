<div id="comments">
	...
	<?php if ( comments_open() ) : ?>
		...
		<div id="respond">
			<h4 class="comentarios-tt">Poste seu comentário</h4>

			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">

				<?php if ( $user_ID ) : ?>

					<p class="comentarios-txt">Autentificado como <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(); ?>" title="Sair desta conta">Sair desta conta &raquo;</a></p>

					<textarea class="input" name="comment" id="comment" placeholder="Comentário..." rows="6" cols=""></textarea>
					
					<input class="comentarios-btn" type="submit" value="Enviar comentário"/>
